		...
		<div class="wrapper-holder">
			...
			<header id="header">
				...
				<a class="menu_trigger" href="#">menu</a>
					<nav id="nav">
						<ul>
							<li><a href="Destaques.php" class="tirarLink"><span class="btn black normal">Destaques</span></a></li>
							<li><a href="Lancamentos.php" class="tirarLink"><span class="btn white normal">Lançamentos</span></a></li>
							<li><a href="Ofertas.php" class="tirarLink"><span class="btn white normal">Ofertas</span></a></li>
						</ul>
					</nav>
					<ul class="tools-nav">
						<li class="items"><a href="cart.php"><span>2</span> Items, <strong>$599.00</strong></a></li>
