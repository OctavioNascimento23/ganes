	...
	<div id="wrapper">
		<div class="wrapper-holder">
			...
			<section id="main">
				...
				<ul class="paging">
					<li class="prev"><a href="products copy 2.php">prev</a></li>
						<li><a href="products.php">1</a></li>
						<li><a href="products copy.php">2</a></li>
						<li><a href="products copy 2.php">3</a></li>
						<li class="active"><a href="products copy 3.php">4</a></li>
						<li><a href="products copy 4.php">5</a></li>
						<li class="next"><a href="products copy 4.php">next</a></li>
					</ul>
				</div>
				...
				<?php
				  ...
				  WHERE idLivro BETWEEN 25 AND 32;";
