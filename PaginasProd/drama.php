				...
				<a class="menu_trigger" href="#">menu</a>
					<nav id="nav">
						<ul>
							...
							<li><a href="drama.php" class="tirarLink"><span class="btn black normal">Drama</span></a></li>
							...
							<div class="image">
								...
								<div class="hover">
									<div class="item-content">
										<a href="../Paginas/Paginas/cart.php" class="btn white normal">Add to cart</a>
										<a href="../Paginas/Paginas/singleproduct.php" class="btn white normal">See details</a>
									</div>
									<span class="bg"></span>
								</div>
							</div>
